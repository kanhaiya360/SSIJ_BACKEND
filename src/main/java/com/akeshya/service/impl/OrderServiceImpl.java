...
public class OrderServiceImpl implements OrderService {
    ...
    public ResponseEntity<?> createOrder(OrderRequest orderRequest) {
        try {
            // For testing - get first user (remove this in production)
            List<User> users = userRepository.findAll();
            if (users.isEmpty()) {
                return ResponseEntity.badRequest().body("No users found in database");
            }
            ...
            Order order = Order.builder()
                    ...
                    .contactPersonName(orderRequest.getContactPersonName())
